// components/cheatsheets/CheatSheetPage.tsx
'use client';
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-3 gap-8">
            ...
            <div className="lg:col-span-2">
              <CheatSheetDisplay cheatSheet={cheatSheet} />
            </div>
            ...
            <div className="space-y-6">
              ...
              <div className="bg-white rounded-xl p-6 shadow-lg border border-emerald-100">
                ...
                <ul className="space-y-3 text-sm text-gray-600">
                  <li className="flex items-start space-x-2">
                    ...
                    <span><strong>Comprehensive Commands:</strong> A wide range of {cheatSheet.title} commands for various tasks</span>
                  </li>
                  <li className="flex items-start space-x-2">
                    <Shield className="h-4 w-4 text-emerald-500 mt-0.5 flex-shrink-0" />
                    <span><strong>Instant Copy:</strong> Copy commands with a single click for quick use</span>
                  </li>
                  <li className="flex items-start space-x-2">
              ...
              <div className="bg-white rounded-xl p-6 shadow-lg border border-emerald-100">
                ...
                <ul className="space-y-3 text-sm text-gray-600">
                  <li className="flex items-start space-x-2">
                    <Zap className="h-4 w-4 text-emerald-500 mt-0.5 flex-shrink-0" />
                    <span><strong>Practice Regularly:</strong> Regular practice helps master {cheatSheet.title} commands</span>
                  </li>
                  <li className="flex items-start space-x-2">
                    <Shield className="h-4 w-4 text-emerald-500 mt-0.5 flex-shrink-0" />
                    <span><strong>Test Before Use:</strong> Always test commands in a safe environment first</span>
                  </li>
                </ul>
              </div>
            </div>
          ...
          <div className="mt-16 max-w-4xl mx-auto prose prose-emerald">
            ...
            <h3>Why Use {cheatSheet.title}?</h3>
