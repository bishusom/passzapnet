...
export const metadata: Metadata = {
  ...
  keywords: 'countdown timer, stopwatch, online timer, presentation timer, classroom timer, meeting timer, full screen timer',
  openGraph: {
    title: 'Countdown Timer & Stopwatch - Full Screen Projection | PassZap',
    description: 'Free online countdown timer and stopwatch with full screen mode. Perfect for presentations, meetings, classrooms, and cooking. No installation required.',
    url: 'https://passzap.net/stopwatch-timer',
    siteName: 'PassZap',
    images: [
      {
...
// Define use cases outside the component to avoid server component issues
const useCases = [
  {
    title: 'Presentations',
